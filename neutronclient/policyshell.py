...
from neutronclient.neutron.v2_0 import groupbasedpolicy as gbp
...
COMMAND_V2 = {
    ...
    'contract-create': gbp.CreateContract,
    'contract-delete': gbp.DeleteContract,
...
class HelpAction(argparse.Action):
    ...
    def __call__(self, parser, namespace, values, option_string=None):
        ...
        app.api_version = '1.0' #Check this
        app.stdout.write(_('\nCommands for Policy API v%s:\n') % app.api_version)
