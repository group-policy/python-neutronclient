...
class CLITestV20PolicyActionJSON(test_cli20.CLITestV20Base):
    ...
    def test_create_policy_action_with_mandatory_params(self):
        ...
        cmd = grouppolicy.CreatePolicyAction(test_cli20.MyApp(sys.stdout),
                                             None)
        name = 'my-name'
        tenant_id = 'my-tenant'
        my_id = 'my-id'
    ...
    def test_list_policy_actions(self):
        ...
        cmd = grouppolicy.ListPolicyAction(test_cli20.MyApp(sys.stdout),
                                           None)
    ...
    def test_show_policy_action_id(self):
        ...
        resource = 'policy_action'
        cmd = grouppolicy.ShowPolicyAction(test_cli20.MyApp(sys.stdout),
                                           None)
    ...
    def test_update_policy_action(self):
        ...
        resource = 'policy_action'
        cmd = grouppolicy.UpdatePolicyAction(test_cli20.MyApp(sys.stdout),
                                             None)
    ...
    def test_delete_policy_action(self):
        ...
        resource = 'policy_action'
        cmd = grouppolicy.DeletePolicyAction(test_cli20.MyApp(sys.stdout),
                                             None)
        my_id = 'my-id'
        args = [my_id]
