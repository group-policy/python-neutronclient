...
class CLITestV20PolicyRuleJSON(test_cli20.CLITestV20Base):
    ...
    def test_create_policy_rule_with_mandatory_params(self):
        ...
        cmd = grouppolicy.CreatePolicyRule(test_cli20.MyApp(sys.stdout),
                                           None)
        name = 'my-name'
        tenant_id = 'my-tenant'
        my_id = 'my-id'
    ...
    def test_list_policy_rules(self):
        ...
        cmd = grouppolicy.ListPolicyRule(test_cli20.MyApp(sys.stdout),
                                         None)
    ...
    def test_show_policy_classifier_id(self):
        ...
        resource = 'policy_rule'
        cmd = grouppolicy.ShowPolicyRule(test_cli20.MyApp(sys.stdout),
                                         None)
    ...
    def test_update_policy_rule(self):
        ...
        resource = 'policy_rule'
        cmd = grouppolicy.UpdatePolicyRule(test_cli20.MyApp(sys.stdout),
                                           None)
    ...
    def test_delete_policy_classifier(self):
        ...
        resource = 'policy_rule'
        cmd = grouppolicy.DeletePolicyRule(test_cli20.MyApp(sys.stdout),
                                           None)
        my_id = 'my-id'
        args = [my_id]
