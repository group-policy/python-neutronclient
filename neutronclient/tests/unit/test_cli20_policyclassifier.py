...
class CLITestV20PolicyClassifierJSON(test_cli20.CLITestV20Base):
    ...
    def test_create_policy_classifier_with_mandatory_params(self):
        ...
        cmd = grouppolicy.CreatePolicyClassifier(test_cli20.MyApp(sys.stdout),
                                                 None)
        name = 'my-name'
        tenant_id = 'my-tenant'
        my_id = 'my-id'
    ...
    def test_list_policy_classifiers(self):
        ...
        cmd = grouppolicy.ListPolicyClassifier(test_cli20.MyApp(sys.stdout),
                                               None)
    ...
    def test_show_policy_classifier_id(self):
        ...
        resource = 'policy_classifier'
        cmd = grouppolicy.ShowPolicyClassifier(test_cli20.MyApp(sys.stdout),
                                               None)
    ...
    def test_update_policy_classifier(self):
        ...
        """
        resource = 'policy_classifier'
        cmd = grouppolicy.UpdatePolicyClassifier(test_cli20.MyApp(sys.stdout),
                                                 None)
    ...
    def test_delete_policy_classifier(self):
        ...
        resource = 'policy_classifier'
        cmd = grouppolicy.DeletePolicyClassifier(test_cli20.MyApp(sys.stdout),
                                                 None)
        my_id = 'my-id'
        args = [my_id]
