...
COMMAND_V2 = {
    ...
    'policy-target-create': grouppolicy.CreateEndpoint,
    'policy-target-delete': grouppolicy.DeleteEndpoint,
    'policy-target-update': grouppolicy.UpdateEndpoint,
    'policy-target-list': grouppolicy.ListEndpoint,
    'policy-target-show': grouppolicy.ShowEndpoint,
    'group-create': grouppolicy.CreateEndpointGroup,
    'group-delete': grouppolicy.DeleteEndpointGroup,
    'group-update': grouppolicy.UpdateEndpointGroup,
    'group-list': grouppolicy.ListEndpointGroup,
    'group-show': grouppolicy.ShowEndpointGroup,
    'l2policy-create': grouppolicy.CreateL2Policy,
    'l2policy-delete': grouppolicy.DeleteL2Policy,
    'l2policy-update': grouppolicy.UpdateL2Policy,
    'l2policy-list': grouppolicy.ListL2Policy,
    'l2policy-show': grouppolicy.ShowL2Policy,
    'l3policy-create': grouppolicy.CreateL3Policy,
    'l3policy-delete': grouppolicy.DeleteL3Policy,
    'l3policy-update': grouppolicy.UpdateL3Policy,
    'l3policy-list': grouppolicy.ListL3Policy,
    'l3policy-show': grouppolicy.ShowL3Policy,
